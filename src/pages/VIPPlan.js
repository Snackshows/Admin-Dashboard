  ...
  const [plans] = useState([
    {
      ...
      name: "Free",
      price: 0,
      features: ["Watch with ads", "SD quality", "Limited content"],
      users: 15000,
      popular: false,
    },
    {
      ...
      name: "Basic",
      price: 4.99,
      features: ["Ad-free", "HD quality", "Download videos", "Early access"],
      users: 3500,
      popular: false,
    },
    {
    ...
    <div className="vip-plan-page">
      ...
      <div className="vip-plans-grid">
        {plans.map((plan) => (
          <div
            key={plan.id}
            className={`vip-plan-card ${plan.popular ? "popular" : ""}`}
          >
            {plan.popular && (
            ...
            <button
              ...
              onClick={() => toast.info("Edit plan coming soon")}
            >
              Manage Plan
            </button>
          </div>
