...
import { FaCrown, FaCheck, FaEdit, FaTrash, FaPlus, FaTimes, FaStar, FaBolt } from 'react-icons/fa';
...
const VIPPlan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        toast.success(response.message || `Subscription ${editMode ? 'updated' : 'created'} successfully`);
        setShowModal(false);
        fetchSubscriptions();
      } else {
  ...
  const getPlanIcon = (planName) => {
    ...
    if (name.includes('ultimate') || name.includes('enterprise')) return <FaBolt />;
    return <FaStar />;
  };
    ...
    <div className="vip-plan-page">
      <div className="page-header-modern">
        <div className="header-content">
          <div className="header-title-section">
            ...
            <p className="page-subtitle">Manage your subscription tiers and pricing</p>
          </div>
          <button className="btn-modern btn-primary-modern" onClick={handleAddNew}>
            <FaPlus /> Add New Plan
          </button>
        </div>
      </div>
      ...
      {plans.length === 0 ? (
        <div className="empty-state-modern">
          ...
          <p>Create your first subscription plan to start offering premium content to your users</p>
          <button className="btn-modern btn-primary-modern" onClick={handleAddNew}>
        ...
        <div className="plans-grid-modern">
          {plans.map((plan, index) => {
            ...
            const savingsPercent = primaryPrice ? calculateSavings(primaryPrice.price, primaryPrice.comparedPrice) : 0;
                ...
                {primaryPrice && (
                  <div className="pricing-section-modern">
                    <div className="price-main">
                      <span className="currency-symbol">{primaryPrice.currency === 'USD' ? '$' : '€'}</span>
                      <span className="price-amount">{primaryPrice.price}</span>
                      <span className="price-period">
                        /{primaryPrice.duration} {primaryPrice.duration > 1 ? 'months' : 'month'}
                      </span>
                    </div>
                    ...
                    {primaryPrice.comparedPrice > primaryPrice.price && (
                      <div className="price-compared">
                        <span className="original-price">
                          {formatCurrency(primaryPrice.comparedPrice, primaryPrice.currency)}
                        </span>
                        {savingsPercent > 0 && (
                    ...
                    {plan.prices.map((price, idx) => (
                      <div key={idx} className="price-option-item">
                        <span className="option-duration">
                          {price.duration} {price.duration > 1 ? 'months' : 'month'}
                        </span>
        ...
        <div className="modal-overlay-modern" onClick={() => setShowModal(false)}>
          <div className="modal-container-modern" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header-modern">
              <h3>{editMode ? 'Edit Subscription Plan' : 'Create New Subscription Plan'}</h3>
            ...
            <form onSubmit={handleSubmit} className="modal-form-modern">
              ...
              <div className="form-section-modern">
                <div className="section-header-modern">
                  ...
                  <button type="button" className="btn-modern btn-add-small" onClick={addFeature}>
                    <FaPlus /> Add Feature
                  </button>
                </div>
              ...
              <div className="form-section-modern">
                <div className="section-header-modern">
                  ...
                  <button type="button" className="btn-modern btn-add-small" onClick={addPrice}>
                    <FaPlus /> Add Price
                  </button>
                </div>
                      ...
                      <div className="price-inputs-row">
                        <div className="form-group-modern">
                          ...
                          <input
                            ...
                            onChange={(e) => updatePrice(index, 'duration', parseInt(e.target.value) || '')}
                      ...
                      <div className="price-inputs-row">
                        <div className="form-group-modern">
                          ...
                          <input
                            ...
                            onChange={(e) => updatePrice(index, 'comparedPrice', parseFloat(e.target.value) || '')}
              ...
              <div className="modal-footer-modern">
                <button type="button" className="btn-modern btn-cancel" onClick={() => setShowModal(false)}>
                  Cancel
                </button>
